    ...
    if (something) {
      gapi.load('auth2', () => {
        ...
        auth2.signIn().then(googleUser => {
          ...
          console.log("Nombre completo:", googleUser.nt.Se)
          console.log("Correo:", googleUser.nt.Yt)
          console.log("Url imagen perfil:", googleUser.nt.oK)
          // console.log("token:", googleUser.Zb.id_token)
          
          sendMutation({
            variables: {
              name: googleUser.nt.JU,
              lastName: googleUser.nt.$S,
